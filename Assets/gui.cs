...
public class gui : MonoBehaviour {
	...
	// MJS - 07/21/2016
	// Removed reorient sections from this script. If you experience orientation issues see >>> videOS_startup_gui.cs
	...
	void readyConfig(){
		...
		if (subID.Substring(1,1) == "5") {
			levelName = "sheltonville_questions";
		}else{
